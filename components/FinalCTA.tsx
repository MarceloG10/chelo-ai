...
export default function FinalCTA() {
  ...
  return (
    <section id="contacto" className="relative py-32 px-6 overflow-hidden">
      ...
      >
        <span className="badge mb-8 inline-block">{t("badge")}</span>

        <h2 className="text-4xl sm:text-5xl md:text-6xl font-bold text-white tracking-tight leading-tight mb-6">
          {t("titlePrefix")}
          <br />
          <span className="text-violet-400 text-glow">{t("titleAccent")}</span>
        </h2>
        ...
        <p className="mt-8 text-white/20 text-sm">{t("disclaimer")}</p>
